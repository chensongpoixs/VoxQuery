...
面向企业的**内部知识库问答系统**，集成**语音对话能力**。解决企业内部员工快速查询业务规范、操作手册、运维文档等知识的痛点需求。
...
│   │   │   ├── config.py                 # 推理参数配置
│   │   │   └── prompt_templates/
│   │   │       └── system_prompt.py      # 智能知识库 System Prompt
│   │   └── scripts/
...
│   ├── dicts/
│   │   ├── energy_terms.txt              # 120+ 行业术语（jieba词典）
...
- **100+ 行业标准术语** 覆盖设备、系统、参数、运维、安全五大类
- **50+ 同义词组**，如：
  - "主变" → "变压器"
  - "PT" → "互感器"
  - "刀闸" → "隔离开关"
